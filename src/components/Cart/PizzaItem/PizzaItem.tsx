...
import { addProduct, itemDecrement, removeProduct } from "redux/cart/slice"
        ...
        <>
            <div className="cart__item">
                ...
                <div className="cart__item-info">
                    <h3>{title}</h3>
                    <p>
                        {TYPE_NAMES[type]}, {SIZE_TYPES[size]} см.
                    </p>
                </div>
                ...
                <div
                    ...
                    onClick={() => {
                        ...
                        console.log(pizza + " in component")
                    }}
                >
